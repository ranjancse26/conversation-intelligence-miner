export default async function getTopics(content: String,
    ...
    const data = {
        messages: [
            ...
            { role: 'user', content: `Extract all the topics from the following content: ${content}. Do not return your own suggestions or recommendations.`}
        ]
    };
