export default async function getTrends(content: String,
    ...
    const data = {
        messages: [
            ...
            { role: 'user', content: `Analyze the trend based on the following content: ${content}`}
        ]
    };
    ...
    try {
        ...
        return "Error while getting a trends";
    }
}